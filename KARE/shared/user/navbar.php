    ...
    <div class="mr-navbar-actions">
        ...
        <div class="mr-avatar-wrap" data-mr-avatar-wrap>
            ...
            <div class="mr-popover" role="menu">
                ...
                <a href="<?= htmlspecialchars($mrRootBase . 'pages/user/settings/settings.php') ?>" class="mr-popover-item" role="menuitem">
                    <i class="ph ph-gear-six"></i> Account settings
                </a>
                <a href="<?= htmlspecialchars($mrRootBase . 'pages/user/report/report.php') ?>" class="mr-popover-item" role="menuitem">
